...
void ERCMain()
{
  ...
  Sleep(3.0);*/
  //Go to compost to start and then to apple bucket test code
  //Drive to compost
  move_arm(50, 40);
  PID_Drive(45, 8.5);
  ...
  /*
  Sleep(0.5);
  compost_motor.SetPercent(30);
  //Turn Motor for specified time
  int Start_Time = TimeNow();
  while((TimeNow() - Start_Time) < 0.95)
  {}
  compost_motor.Stop();
  Sleep(0.5);*/
 ...
 /*
  //drive to front of ramp & line up with wall
  PID_Drive(-45,6);
  PID_Turn(45, 145);
  PID_Drive(45,8);
  turn_left(35);
